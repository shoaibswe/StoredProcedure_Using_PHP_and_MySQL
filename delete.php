...
<div id="particles-js" style="position: absolute;z-index: 2;"><canvas class="particles-js-canvas-el" width="1349" height="600" style="width: 100%; height: 100%;"></canvas></div>
      <div class="intro-content" style="position: relative;">
         <div class="intro-overlay"></div>
            ...
            <div class="col-twelve">
                              <h2>Hello Ma'am</h2>
               <h1 style="color: white">Delete Info from Below</h1>
 ...
 if (isset($_POST['submitbtn'])) 
 {
   ...
   $query= "CALL dlt_data('$studid','$labid','$sem')";
   if (mysqli_query($conn,$query)) {
            header("location:delete.php?deleted=1");
   }
} 
 if (isset($_GET["deleted"])) {
   echo '<script>alert("Information Deleted Succesfully!")</script>';
 }
 else {echo "Hello Mam, You did not delete yet :) ";}
 ?>
...
<section id="margined">
   ...
   <section id="services" class="grey-section">
...
<tr>
   <td></td>
   <td>
      <input type="submit" value="delete" name="submitbtn">
   </td>
</tr> 
